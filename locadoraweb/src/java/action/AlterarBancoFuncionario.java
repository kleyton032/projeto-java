...
@WebServlet("/AlterarBancoFuncionario")
public class AlterarBancoFuncionario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public AlterarBancoFuncionario() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dao.AlterarFuncionario(novoCadastrar); 
