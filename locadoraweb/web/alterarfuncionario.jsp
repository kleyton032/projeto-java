...
<html lang="pt-br">
    <head>
        ...
        <title>AUTO MC - Alterar Funcionário</title>
    </head>
    <body>
        <header>
                <div class="navgar">
        ...
        <section>
            ...
            <% 
            Cadastrar funcionario = (Cadastrar)request.getAttribute("funcionario");
            %>

            <form action="AlterarBancoFuncionario" method="post" class="formulario" id="formulario">
                <label for="matricula">Matrícula: </label></br>
                <input class="campos" type="number" name="matricula" id=matricula placeholder="0000000" value="<%=funcionario.getMatricula()%>"/></br><label id="erromatricula"></label></br>

                <label for="nome">Nome completo do funcionário: </label></br>
                <input class="campos" type="text" name="nome" id=nome placeholder="Coloque o nome completo" value="<%=funcionario.getNome()%>" /></br><label id="erronome"></label></br>

                <label for="cpf">CPF: </label></br>
                <input class="campos" type="number" name="cpf" placeholder="00000000000" id=cpf value="<%=funcionario.getCPF()%>" /></br><label id="errocpf"></label></br>
                ...
                <input class="campos" type="email" name="email" id=email placeholder="exemplo@exemplo.com" value="<%=funcionario.getEmail()%>" /></br><label id="erroemail"></label></br>

                <label for="tel">Telefone: </label></br>
                <input class="campos" type="number" name="tel" id=tel placeholder="0000000000" value="<%=funcionario.getTelefone()%>" /></br><label id="errotel"></label></br>
                ...
                <input class="campos" type="text" name="cidade" id=cidade placeholder="Exemplo" value="<%=funcionario.getCidade()%>" /><br><label id="errocidade"></label><br>

                <label for="bairro">Bairro: </label><br>
                <input class="campos" type="text" name="bairro" id=bairro placeholder="Exemplo" value="<%=funcionario.getBairro()%>" /><br><label id="errobairro"></label><br>

                <label for="rua">Rua: </label><br>
                <input class="campos" type="text" name="rua" id=rua placeholder="Exemplo" value="<%=funcionario.getRua()%>" /></br><label id="errorua"></label></br>
