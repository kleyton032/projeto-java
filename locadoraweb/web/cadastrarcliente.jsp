...
<html lang="pt-br">
    <head>
        ...
        <title>AUTO MC - Cadastrar Cliente</title>
    </head>
    <body>
        <header>
            <div class="navgar">
                    ...
                    <ul>
                        ...
                        <li class="dropdown"><a data-toggle="dropdown" href="#">CADASTROS</a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropmenu" href="#">CADASTRAR CLIENTE</a></li>
        ...
        <section>
            ...
            <form action="InserirFormCliente" method="post" class="formulario" id="formulario">

                <label for="nome">Nome completo do cliente: </label></br>
    ...
    <script type="text/javascript" src="js/javascriptCliente.js" charset="UTF-8"></script>
    </body>
</html>