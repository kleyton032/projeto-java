...
<html>
    <head>
        ...
        <title>AUTO MC - Consultar Funcionário</title>
    </head>
    <body>
                ...
                <nav>
                    <ul>
                        ...
                        <li class="dropdown"><a data-toggle="dropdown" href="#">CONSULTAS</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropmenu" href="#">CONSULTAR FUNCIONÁRIO</a></li>
        ...
        <section>
            <h1>Consulta de funcionários</h1></br></br>
            ...
            <div class="table-responsive">
                <table id="dados" class="table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td> <%= c.getBairro() %></td>
                        <td> <%= c.getRua() %></td>
                        <th><a href="DeletarFuncionario?matricula=<%= c.getMatricula() %>">Excluir</a></th>
                        <th><a href="AlterarFuncionario?matricula=<%= c.getMatricula() %>">Alterar</a></th>
